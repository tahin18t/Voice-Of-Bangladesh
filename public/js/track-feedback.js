...
function printDetails() {
    ...
    if (!trackResults || trackResults.style.display === 'none') {
        alert('Please track a feedback first before printing.');
        return;
    }

    // Add print date attribute for the CSS ::after pseudo-element
    ...
    trackResults.setAttribute('data-print-date', currentDate);

    // Add a print-specific class to body
    document.body.classList.add('printing');

    // Hide elements we don't want to print (backup for browsers that don't support CSS @media print well)
    const elementsToHide = [
        document.querySelector('.track-actions'),
        document.querySelector('.main-nav'),
        document.querySelector('.footer'),
        document.querySelector('.search-container'),
        document.querySelector('.sample-ids')
    ];
    ...
    // Give browser time to process changes before printing
    setTimeout(() => {
        // Print
        window.print();
...
// Make printDetails available globally
